...
public class CommentFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.iuh.thachnglk.coderschool.R.layout.fragment_comment, container);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        status = (TextView) view.findViewById(com.iuh.thachnglk.coderschool.R.id.textView_comment_status);
        button_tweet = (Button) view.findViewById(com.iuh.thachnglk.coderschool.R.id.button_comment_tweet);
        ...
        text = (EditText)view.findViewById(com.iuh.thachnglk.coderschool.R.id.editText_comment_text);
