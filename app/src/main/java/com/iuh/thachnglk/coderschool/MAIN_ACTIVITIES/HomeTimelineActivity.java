...
import com.iuh.thachnglk.coderschool.OTHER_USEFUL_CLASS.EndlessRecyclerViewScrollListener;
import com.iuh.thachnglk.coderschool.OTHER_USEFUL_CLASS.GlobalVariable;
import com.iuh.thachnglk.coderschool.TWEET_RECYCLERVIEW.TweetAdapter;
...
public class HomeTimelineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.iuh.thachnglk.coderschool.R.layout.activity_home_timeline);
    ...
    private void registerWidgets() {
        ...
        swipeContainer = (SwipeRefreshLayout) findViewById(com.iuh.thachnglk.coderschool.R.id.swipeContainer);
        toolbar = (Toolbar) findViewById(com.iuh.thachnglk.coderschool.R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
        linearLayoutManager = new LinearLayoutManager(this);
        recyclerView = (RecyclerView) findViewById(com.iuh.thachnglk.coderschool.R.id.recyclerView_tweets);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(linearLayoutManager);
        tweets = new ArrayList<>();
        button = (FloatingActionButton)findViewById(com.iuh.thachnglk.coderschool.R.id.fab);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.iuh.thachnglk.coderschool.R.menu.login,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case com.iuh.thachnglk.coderschool.R.id.menu_action_profile:
            {
                Intent i = getIntent();
                String id = i.getStringExtra(GlobalVariable.CURRENT_USER_ID);
