package com.iuh.thachnglk.coderschool.TWEET_RECYCLERVIEW;
...
import com.iuh.thachnglk.coderschool.COMMENT_RETWEET_LIKE_SHARE.CommentFragment;
import com.iuh.thachnglk.coderschool.OTHER_USEFUL_CLASS.GlobalVariable;
import com.iuh.thachnglk.coderschool.COMMENT_RETWEET_LIKE_SHARE.RetweetFragment;
import com.iuh.thachnglk.coderschool.TWITTER_CLIENT.TwitterApplication;
import com.iuh.thachnglk.coderschool.TWITTER_CLIENT.TwitterClient;
...
public class TweetAdapter extends RecyclerView.Adapter<TweetAdapter.TweetViewHolder> {
    ...
    public TweetViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(com.iuh.thachnglk.coderschool.R.layout.item_tweet, parent, false);
    ...
    public void onBindViewHolder(final TweetViewHolder holder, int position) {
        ...
        if (tweet.isFavorited() == true) {
            Drawable drawable = context.getResources().getDrawable(com.iuh.thachnglk.coderschool.R.drawable.ic_favorite_white_24dp);
            holder.favorited.setImageDrawable(drawable);
        } else {
            Drawable drawable = context.getResources().getDrawable(com.iuh.thachnglk.coderschool.R.drawable.ic_favorite_black_24dp);
            holder.favorited.setImageDrawable(drawable);
        }

        if (tweet.isRetweeted() == true) {
            Drawable drawable = context.getResources().getDrawable(com.iuh.thachnglk.coderschool.R.drawable.ic_repeat_white_24dp);
            holder.retweet.setImageDrawable(drawable);
        } else {
            Drawable drawable = context.getResources().getDrawable(com.iuh.thachnglk.coderschool.R.drawable.ic_repeat_black_24dp);
            holder.retweet.setImageDrawable(drawable);
        }
                    ...
                    public void accessResponse(String s) {
                        ...
                        client.postComment(String.valueOf(tweet.getUid()), s, new JsonHttpResponseHandler() {
                            ...
                            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                                ...
                                Drawable drawable = context.getResources().getDrawable(com.iuh.thachnglk.coderschool.R.drawable.ic_chat_bubble_white_24dp);
        ...
        holder.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Drawable drawable = context.getResources().getDrawable(com.iuh.thachnglk.coderschool.R.drawable.ic_share_white_24dp);
    ...
    public static class TweetViewHolder extends RecyclerView.ViewHolder {
        ...
        public TweetViewHolder(View itemView) {
            super(itemView);
            profile_image = (ImageView) itemView.findViewById(com.iuh.thachnglk.coderschool.R.id.imageView_comment_profile_image);
            videoView = (VideoView) itemView.findViewById(com.iuh.thachnglk.coderschool.R.id.videoView_video);
            name = (TextView) itemView.findViewById(com.iuh.thachnglk.coderschool.R.id.textView_comment_profile_name);
            createAt = (TextView) itemView.findViewById(com.iuh.thachnglk.coderschool.R.id.textView_comment_create_at);
            status = (TextView) itemView.findViewById(com.iuh.thachnglk.coderschool.R.id.textView_tweet_status);
            retweet_count = (TextView) itemView.findViewById(com.iuh.thachnglk.coderschool.R.id.textView_tweet_retweetcount);
            favorite_count = (TextView) itemView.findViewById(com.iuh.thachnglk.coderschool.R.id.textView_tweet_favorite_count);
            main_image = (ImageView) itemView.findViewById(com.iuh.thachnglk.coderschool.R.id.imageView_tweet_imageURL);
            comment = (ImageView) itemView.findViewById(com.iuh.thachnglk.coderschool.R.id.imageView_tweet_comment);
            share = (ImageView) itemView.findViewById(com.iuh.thachnglk.coderschool.R.id.imageView_tweet_share);
            retweet = (ImageView) itemView.findViewById(com.iuh.thachnglk.coderschool.R.id.imageView_tweet_retweet);
            favorited = (ImageView) itemView.findViewById(com.iuh.thachnglk.coderschool.R.id.imageView_Tweet_like);
